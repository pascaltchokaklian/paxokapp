...
class ColsDetailView(generic.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for cp in listColPerform:                        
            ...
            f_debug_trace("views.py","ColsDetailView",pk_activity)
            myActivities= Activity.objects.filter(strava_id = pk_activity)
            for lactivity in myActivities:                                
                f_debug_trace("views.py","strava_user_id",strava_user_id)
                f_debug_trace("views.py","lactivity.strava_user_id",lactivity.strava_user_id)
