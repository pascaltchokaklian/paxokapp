...
urlpatterns = [
    ...
    path('activity/<int:act_id>/recalculate-cols/', recalculate_activity_cols, name='activity-recalculate-cols'),
    ...
    path('colsok_map/', colsok_map, name='colsok_map'),
    ...
    path('m_colsok_map/', colsok_map, name='m_colsok_map'),
